          ...
          <defs>
            {pathData.map((_, i) => (
              <linearGradient
                ...
                y2="100%"
              >
                <stop offset="0%" stopColor="#D3D3D9" stopOpacity="0" />
                <stop offset="20%" stopColor="#D3D3D9" stopOpacity="1" />
                <stop offset="50%" stopColor="#E5A422" stopOpacity="1" />
                <stop offset="80%" stopColor="#703B17" stopOpacity="1" />
                <stop offset="100%" stopColor="#703B17" stopOpacity="0" />
              </linearGradient>
            ))}
          </defs>
        </svg>
...
export default function BackgroundBeamsDemo() {
  return (
    <div className="absolute h-screen w-screen overflow-hidden bg-bg-primary">
      <BackgroundBeams />
    </div>
  );
}
