...
export default function Hero() {
  return (
    ...
    >
      <div className="flex gap-16 items-stretch max-w-310 w-full flex-1 min-h-px px-8">
        {/* Left: headline + body + CTAs */}
        <div className="flex-1 flex flex-col gap-10 items-start justify-center min-w-0 py-24">
          <div className="flex flex-col gap-5 items-start w-full">
            <h1 className="font-medium text-[60px] leading-18 tracking-[-1.5px] text-[#0f172a]">
              Know who you&apos;re onboarding before they cost you.
            </h1>
            <p className="text-[21px] leading-7-5 text-[#475569]">
        ...
        <div className="flex-1 bg-bg-alt flex items-center justify-center min-w-0 overflow-clip py-24">
          <ReportCard />
        </div>
      </div>
    </section>
