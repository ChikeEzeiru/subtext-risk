...
function ScanLine({
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(90deg, transparent 10%, #ca7d15 40%, #e5a422 50%, #ca7d15 60%, transparent 90%)",
  ...
  return (
    <p className="text-[17px] leading-6 font-medium text-[#17171c]">
      ...
      {started && displayed.length < text.length && (
        <span
          className="inline-block ml-px align-bottom"
          style={{
            width: 1.5,
            height: "1em",
            background: "#17171c",
...
function RiskBar({
  ...
  return (
    <div className="flex items-center gap-2 w-full">
      <div className="flex-1 relative h-1 rounded-lg">
        <div className="absolute inset-0 bg-bg-alt rounded-[4px]" />
        <div
          className="absolute left-0 top-0 bottom-0 bg-success rounded-[4px]"
          style={{
            width: filled ? "17.9%" : "0%",
...
function AnalysisTimer({
  ...
  return (
    <div
      ...
      style={{ opacity: counting ? 1 : 0, transition: "opacity 0.5s ease" }}
    >
      <Clock size={14} className="text-accent shrink-0" />
      <span className="font-mono font-medium text-[11px] leading-4 text-accent">
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <Icon size={14} className="text-body shrink-0" />
        <span className="text-[12px] leading-4.5 text-body">{label}</span>
      </div>
      <div className="flex items-center gap-2">
        {extra ? (
          <div
          ...
          >
            <span className="text-[12px] leading-4.5 font-medium text-[#17171c]">
              {value}
            </span>
            <div className="size-0.5 rounded-full bg-[#17171c] shrink-0" />
            <span className="text-[12px] leading-4.5 font-medium text-[#17171c]">
              {extra}
            </span>
          </div>
          ...
          <span
            className="text-[12px] leading-4.5 font-medium text-[#17171c]"
            style={{
              opacity: resolved ? 1 : 0,
              transition: "opacity 0.4s ease",
            }}
...
export default function ReportCard() {
  ...
  return (
    <div
      ref={cardRef}
      className="bg-white border border-border rounded-sm min-w-105 flex flex-col overflow-clip relative"
      style={{
        boxShadow: "0px 1px 2px 0px rgba(0,0,0,0.05)",
        animation: triggered ? "subtlePulse 4s ease infinite 4s" : "none",
      }}
    >
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b border-border">
        <FadeIn delay={200} triggered={triggered}>
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-[11px] leading-4 tracking-[0.33px] text-body">
              MERCHANT RISK REPORT
            </span>
          </div>
        </FadeIn>
        <FadeIn delay={3800} triggered={triggered}>
          <div className="flex items-center gap-1.5 bg-success-bg border border-success-border rounded-[12px] px-2.5 pb-1 pt-1.25">
            <div className="size-1.5 rounded-full bg-success shrink-0" />
            <span className="font-mono text-[10px] leading-2.5 tracking-[-0.1px] text-success-text">
              VERIFIED
            </span>
          </div>
        </FadeIn>
      ...
      <div className="flex flex-col gap-2 px-5 py-4">
        ...
        <div className="flex flex-col gap-3 pb-2">
          <div className="flex flex-col gap-3">
            <TypingText
              text="Meridian Coffee Co."
              delay={600}
              speed={40}
              triggered={triggered}
            />
            <FadeIn delay={1200} triggered={triggered}>
              <p className="font-mono text-[11.5px] leading-4 tracking-[0.115px] text-body">
                meridian-coffee.com
              </p>
            </FadeIn>
          </div>
        ...
        <div className="flex items-center justify-between pt-3 pb-2">
          ...
          <FadeIn delay={4200} triggered={triggered}>
            <div className="flex items-center gap-2 font-mono text-[10px] leading-4 tracking-[0.1px] text-body-dark">
              <span>SUBTEXT</span>
              <span>v1.02</span>
            </div>
          </FadeIn>
