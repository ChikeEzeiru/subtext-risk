...
export default function HowItWorks() {
  ...
  return (
    ...
    >
      <div className="max-w-310 w-full px-4 md:px-8 flex justify-center">
        <h2 className="text-[32px] leading-10 md:text-[48px] md:leading-15 font-medium tracking-[-0.96px] text-[#17171c] text-center">
          Here&apos;s what happens
          <br />
          in those 30 seconds
        </h2>
      ...
      <div className="max-w-310ll px-4 md:px-8 flex flex-col md:flex-row gap-4 items-stretch">
        {cards.map(
