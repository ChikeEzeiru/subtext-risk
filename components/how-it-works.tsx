...
export default function HowItWorks() {
  ...
  return (
    <section ref={sectionRef} className="w-full py-24 flex flex-col items-center gap-16">
      ...
      <div className="max-w-[1240px] w-full px-8 flex justify-center">
        <h2 className="text-[48px] leading-[60px] font-medium tracking-[-0.96px] text-[#17171c] text-center">
          Here&apos;s what happens
          <br />
          in those 30 seconds
        </h2>
      ...
      <div className="max-w-[1240px] w-full px-8 flex gap-4 items-stretch">
